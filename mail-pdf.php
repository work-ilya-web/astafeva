<?php
 ...
 $to = 'evgeniifedorovskii95@mail.ru';
 ...
 $send = mail ($to, $info['site'] ,$mess,"Content-type:text/html; charset = utf-8\r\nFrom:evgeniifedorovskii95@mail.ru");
 $send = mail ('evgeniifedorovskii95@mail.ru', $info['site'] ,$mess,"Content-type:text/html; charset = utf-8\r\nFrom:evgeniifedorovskii95@mail.ru");

 //echo "<pre>"; print_r($_POST); echo "</pre>";
 header('Location: lake-house.pdf');
